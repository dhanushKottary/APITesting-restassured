...
public class UserTest {
	...
	public void testUpdateUser() {
		...
		Response getUpdatedUserResponse = UserEndpoints.getUser(this.userPayload.getUsername());
	...
	public void testDeleteUser() {
		...
		Response getDeletedUserResponse = UserEndpoints.getUser(this.userPayload.getUsername());
